...
const Landing = () => {
  ...
  const [faqs, setFaqs] = useState([
    {
      heading: 'What is Recruuit Search?',
      content:
        'Recruuit search is an AI-powered platform that allows companies to find top talent around the world. ',
      shown: false,
    },
    {
      heading: 'How Smart Search Helps to find better candidates?',
      content:
        'Recruuit search provides an AI-powered smart search feature, by the help of this feature employees can find talent according to location, soft skills, technical skills, work experience and education. With just a couple of clicks our AI powered algorithm will provide top talent accoridng to your needs. ',
      shown: false,
    },
    {
      heading: 'What are some great features in upcoming updates?',
      content:
        'We are constantly improving Recruuit Search to provide top-notch AI features to employees.  In the upcoming updates, we will provide an improved version of smart search which will directly find top candidates according to a specific job posting, we will also provide a candidate tracking feature which will help hiring managers to track each selected candidate and it will also be helpful for us to improve our AI algorithm. ',
      shown: false,
    },
  ])
  ...
  const cardsContent = [
    {
      ...
      description:
        'Recruuit is a Machine Learning platform that learns from your previous successful and unsuccessful matches. We will connect the software to your hiring history and help you find better and faster matches with future candidates.',
    },
    {
      img: 'img2.png',
      heading: 'Smart Search',
      description:
        "Recruuit uses Deep Neural Networks to not only learn from your companies prior matches with candidates but also find soft skills in CV's and publicly available information from candidates.",
    },
    {
      img: 'img3.png',
    ...
    <>
      ...
      <nav className='bg-white custom_nav border-gray-200 px-5 sm:px-4 py-2.5 fixed top-0 left-0 right-0 border-1 border-gray-100 dark:bg-gray-800 z-30'>
        <div className='flex flex-wrap justify-between items-center mx-auto'>
          ...
          >
            <img
              src={require('./../../assests/recruuitLogo.png')}
            ...
            <div className='gap-3 flex flex-wrap w-full'>
              <div className='pl-3 md:pt-20 md:w-6/12 xl:pl-36 xl:pt-36 2xl:pl-44 2xl:pt-44'>
                <h2 className='text-3xl font-bold lg:w-9/12 xl:w-9/12 xl:text-4xl 2xl:text-5xl'>
                  <span className='highlight'>Recruuit</span> A Smart
                  Recruitment Solution
                </h2>
                <p className='text-gray-500 text-sm font-medium w-75 xl:w-7/12 2xl:w-6/12'>
                  Recruuit provides easy and smart recruitment solutions, by
                  which Tech Companies & Scale Ups can easily hire talented
                  candidates{' '}
                </p>
                <div className='mt-4'>
                  <button
              ...
              <div id='section3'>
                <div className='flex flex-wrap md:gap-0 md:justify-between'>
                  ...
                  <div className='md:w-6/12 text-justify text-xl text-gray-600 font-normal'>
                    {' '}
                    Recruuit Search was created by Hajo van Beijma and Abdul
                    Rehman.
                    <br />
                    <br />
                    Hajo van Beijma is the founder of Atilax and helps tech
                    companies and scale-ups with finding new talent. He connects
                    leaders to the right scale-ups. This is a role well-suited
                    to him and inline with his executive search experiences and
                    as a tech entrepreneur. Hajo is supported by a tech team
                    developing a Deep Learning approach using Transformers to
                    help match candidates with jobs.
                    <br />
                    <br />
                    Abdul Rehman is a tech team member of Atilax. He is a
                    freelance data scientist and full-stack web developer.
                    Having effective communication, management, and technical
                    skills he solves business problems and provides technical
                    solutions to help grow the business.
                    <br />
                    <br />
                    Recruuit is an innovative platform that can change the way
