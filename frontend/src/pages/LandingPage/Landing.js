...
const Landing = () => {
  ...
  const [faqs, setFaqs] = useState([
    {
      heading: "What is SmartEd?",
      content:
        "It is smart educational solution for aspiring students and inspiring teachers",
      shown: false,
    },
    {
      heading: "How SmartEd Helps to find better teachers?",
      content:
        "It is smart educational solution for aspiring students and inspiring teachers",
      shown: false,
    },
    {
      heading: "What are some great features in SmartEd?",
      content: "Smart course search, grading and better evaluation",
      shown: false,
    },
  ]);
            ...
            <div className="gap-3 flex flex-wrap w-full">
              <div className="pl-3 md:pt-20 md:w-6/12 xl:pl-36 xl:pt-36 2xl:pl-44 2xl:pt-44">
                <h2 className="text-3xl font-bold lg:w-9/12 xl:w-9/12 xl:text-4xl 2xl:text-5xl">
                  <span className="highlight">SmartEd</span> A Smart online
                  education solution
                </h2>
                <p className="text-gray-500 text-sm font-medium w-75 xl:w-7/12 2xl:w-6/12">
                  SmartEd provides easy and smart educational solutions, by
                  which students & teachers can easily fulfill their educational
                  needs{" "}
                </p>
                <div className="mt-4">
                  <button
            ...
            <div id="section2" className="w-100">
              <div className="flex justify-center text-center text-4xl font-semibold">
                <div className=" 2xl:w-3/12">
                  ...
                  <span style={{ color: "#4E79CF" }}>Educational</span> Solution
                </div>
              </div>
              ...
              <div id="section3">
                <div className="flex flex-wrap md:gap-0 md:justify-between">
                  ...
                  <div className="md:w-6/12 text-justify text-xl text-gray-600 font-normal">
                    {" "}
                    Meerkat Search was created by Hajo van Beijma and Abdul
                    Rehman.
                    <br />
                    <br />
          ...
          <div className="gap-3 flex flex-wrap">
            ...
            <div className="ml-4 mb-4 w-72 2xl:ml-64">
              ...
              <p className="pt-4 text-justify text-gray-500">
                Smart focusses on educational institutes & students. We help you find
                your new competetive candidates with a focus on learning,
                and teaching{" "}
              </p>
              <div className="pt-3">
                <span style={{ marginBottom: "0rem !important" }}>Phone</span>
